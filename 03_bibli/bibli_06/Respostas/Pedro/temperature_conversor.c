...
float convert_kelvin_to_fahrenheit(float temperature){
    return temperature = convert_celsius_to_fahrenheit(convert_kelvin_to_celsius(temperature));
}
...
float convert_fahrenheit_to_kelvin(float temperature){
    return temperature = convert_celsius_to_kelvin(convert_fahrenheit_to_celsius(temperature));
}
