 ...
 */
tMatrix MatrixCreate(int rows, int cols); //já foi
 ...
 */ 
tMatrix MatrixRead(tMatrix matrix); //já foi

/**
 * @brief Imprime uma matriz na saída padrão.
 * @param matrix A matriz a ser impressa.
 */
void MatrixPrint(tMatrix matrix); //já foi
 ...
 */
int PossibleMatrixSum(tMatrix matrix1, tMatrix matrix2); //já foi
 ...
 */
int PossibleMatrixSub(tMatrix matrix1, tMatrix matrix2); //já foi
 ...
 */ 
int PossibleMatrixMultiply(tMatrix matrix1, tMatrix matrix2); //já foi
 ...
 */
tMatrix MatrixAdd(tMatrix matrix1, tMatrix matrix2); //já foi
 ...
 */
tMatrix MatrixSub(tMatrix matrix1, tMatrix matrix2); //já foi
 ...
 */
tMatrix MatrixMultiply(tMatrix matrix1, tMatrix matrix2); //já foi
 ...
 */
tMatrix TransposeMatrix(tMatrix matrix); //já foi
 ...
 * @return O resultado da multiplicação.
 */
tMatrix MatrixMultiplyByScalar(tMatrix matrix, int scalar); //já foi
