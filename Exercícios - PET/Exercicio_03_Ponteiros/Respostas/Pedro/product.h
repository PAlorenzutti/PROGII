 ...
 */
void leProduto(tProduct *produto); //já foi
 ...
 * @param id Identificador de cada produto.
 */
void criaProduto(tProduct *produto, char* nome, float desconto, float preco, int estoque, int id); //já foi

/**
 * @brief Retorna o desconto atual de um produto
 * @param produto O endereço do produto.
 * @return O desconto.
*/
...
*/
void aumentaEstoqueProduto(tProduct *produto, int qtd); //já foi
...
*/
void vendeProduto(tProduct *produto, int qtd); //já foi
...
*/
void atualizaDesconto(tProduct *produto, float desconto); //já foi
 ...
 * Produto: <nome>, ID: <id>, Preco atual: <preco>, Qtd no estoque: <estoque>, Qtd vendida: <vendas>
 * @brief Deve possuir quebra de linha ao final
 * @param produto O endereço produto a ser impresso.
*/
