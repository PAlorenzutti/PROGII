...
*/
void abreLoja(tStore *loja); //já foi
...
*/
void adicionaProduto(tStore *loja, tProduct produto); //já foi
...
*/
void aumentaEstoqueLoja(tStore *loja, int id, int qtd); //já foi
...
*/
void vendeProdutoLoja(tStore *loja, int id, int qtd); //já foi
...
*/
void atualizaDescontoLoja(tStore *loja, int id, float desconto); //já foi
